...
// Load the register page, call the guest filter before to check if user already logged in
Route::get('register',  array('as' => 'register','uses'=>'AuthController@register'))->before('guest');
...
Route::group(array('before' => 'auth'), function() {
	...
	// Create all methods for user, user page, save a new user(register) and destroy a user
	Route::resource('user', 'RepliesController', array('only' => array('index', 'store', 'destroy')));
});